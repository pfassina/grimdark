...
class TilesetLoader:
    ...
    def _create_fallback_config(self) -> TilesetConfig:
        ...
        fallback_data = {
            'tiles': {
                1: {'terrain_type': 'plain', 'move_cost': 1, 'defense_bonus': 0, 'avoid_bonus': 0, 'blocks_movement': False, 'blocks_vision': False},
                2: {'terrain_type': 'forest', 'move_cost': 2, 'defense_bonus': 1, 'avoid_bonus': 20, 'blocks_movement': False, 'blocks_vision': False},
                3: {'terrain_type': 'mountain', 'move_cost': 3, 'defense_bonus': 2, 'avoid_bonus': 30, 'blocks_movement': False, 'blocks_vision': False},
                4: {'terrain_type': 'water', 'move_cost': 99, 'defense_bonus': 0, 'avoid_bonus': 0, 'blocks_movement': True, 'blocks_vision': False},
                5: {'terrain_type': 'road', 'move_cost': 1, 'defense_bonus': 0, 'avoid_bonus': 0, 'blocks_movement': False, 'blocks_vision': False},
                6: {'terrain_type': 'fort', 'move_cost': 1, 'defense_bonus': 3, 'avoid_bonus': 10, 'blocks_movement': False, 'blocks_vision': False},
                7: {'terrain_type': 'bridge', 'move_cost': 1, 'defense_bonus': 0, 'avoid_bonus': 0, 'blocks_movement': False, 'blocks_vision': False},
                8: {'terrain_type': 'wall', 'move_cost': 99, 'defense_bonus': 0, 'avoid_bonus': 0, 'blocks_movement': True, 'blocks_vision': True},
            },
            'terrain_to_tile_id': {
                'plain': 1, 'forest': 2, 'mountain': 3, 'water': 4,
                'road': 5, 'fort': 6, 'bridge': 7, 'wall': 8
            }
        }
